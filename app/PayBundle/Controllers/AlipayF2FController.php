...
use \Omnipay\Omnipay;
class AlipayF2FController extends   Controller{
...
public function  index(Request $request,Response $response){
    ...
    return $this->view->render($response, 'Index/alipay_f2f_test.twig');
}
...
// 获取收款二维码内容
    $qrCodeContent = $response->getQrCode();
        ...
        return ("<html><head></head><body><img src='".$qrCodeContent."' width=200 height=200/></body></html>");
    }else{
